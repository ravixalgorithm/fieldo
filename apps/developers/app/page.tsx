        ...
        <div className="docs-grid">
          <div className="docs-card">
            ...
            <p>
              ...
              read submissions, diagnose drop-off, generate embed code. <Link href="/mcp-server">Set up MCP →</Link>
            </p>
          </div>
          <div className="docs-card">
            ...
            <p>
              ...
              partials, send analytics beacons. <Link href="/rest-api">REST API →</Link>
            </p>
          </div>
        </div>
      </Section>
...
→ generate_embed_code({ id: "frm_...", target: "framer" })`}</Code>
   ...
   └─ observe: inbox · spam folder · field-level funnel (reach, dwell,
        ...
        <Callout>
          Everything below runs locally today: dashboard on <C>{DASHBOARD_URL}</C>, single workspace, no auth.
          OAuth scopes ship with the hosted version — they are documented where relevant so integrations are
          forward-compatible.
        </Callout>
      </Section>
