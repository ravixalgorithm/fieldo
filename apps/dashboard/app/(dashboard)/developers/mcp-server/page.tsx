...
import { PageHeader, Section, P, Code, C, DocTable, PageFooter, Callout, devHref } from "@/components/developers/docs";
    ...
    <>
      ...
      <Section title="What your agent can do">
        ...
        <Callout>
          ...
          from a sentence to a live form on your site. See <Link href={devHref("/tools")}>MCP Tools</Link> for the catalog.
        </Callout>
      </Section>
